...
class Finetuning(BaseLearner):
    ...
    def _update_representation(self, args_type, train_loader, test_loader, optimizer_conv, scheduler_conv, optimizer_fc, scheduler_fc):
        ...
        for epoch in range(1, init_epoch + 1):
            ...
            info = 'Task [{}/{}], \tEpoch [{}/{}] \t=> \tconv lr = {:.6f}, \tfc lr = {:.6f}, \tloss = {:.3f}, \tloss_clf = {:.3f}, \tloss_triplet = {:.3f}, \tTrain_accy = {:.3f}'.format(
                ...
                losses / len(train_loader), loss1 / len(train_loader), loss2 / len(train_loader),
                train_acc
            )
